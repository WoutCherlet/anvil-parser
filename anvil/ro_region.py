...
class RORegion:
    ...
    def get_chunk(self, chunk_x: int, chunk_z: int) -> 'anvil.ROChunk':
        """
        Returns the chunk at given coordinates,
        same as doing ``ROChunk.from_region(region, chunk_x, chunk_z)``
        ...
        :rtype: :class:`anvil.ROChunk`
        """
        return anvil.ROChunk.from_region(self, chunk_x, chunk_z)
